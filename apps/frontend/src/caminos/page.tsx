...
export default function CaminosPage() {
  return (
    <main className="flex flex-1 flex-col px-4 py-16 sm:px-6 lg:px-8 border border-red-500 bg-red-100">
      <h1 className="text-3xl font-bold tracking-tight">xxxx Caminos</h1>
